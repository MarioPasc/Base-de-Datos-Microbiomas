...
class JSONExporter:
    ...
    def export_to_josn_microorganisms(self, microorganisms: List[Microorganism], output_file:str) -> None:
...
def main():
    ...
    exporter.export_to_json(patients, output_file_patient)
    exporter.export_to_josn_microorganisms(microorganisms=microorganisms, output_file=output_file_microorganisms)
