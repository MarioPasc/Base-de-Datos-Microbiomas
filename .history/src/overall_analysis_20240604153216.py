...
def main() -> None:
    base = "query_optimization"
    analizer = OverallAnalysis(
        xml_path=os.path.join(base, "XML", "ExecutionTimeXml.csv"),
        mongo_path=os.path.join(base, "mongodb", "encoded_performance_mongodb_docker.csv"),
