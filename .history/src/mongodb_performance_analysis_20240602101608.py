...
def encode_and_save_csv(input_file, output_file):
    ...
    index_codes = {
        ...
        "(('samples.sample_id', 1), ('samples.microorganism<|vq_3886|>1), ('microorganism_id', 1))": "I1+I2+I5",
...
def main():
    input_file = '/mnt/data/encoded_performance_mongodb.csv'
    output_file = '/mnt/data/encoded_performance_mongodb_output.csv'
