...
class JSONExporter:
    ...
    def insert_patients_to_mongodb(self, patients: List[Patient], collection:str):
        collection_object = self.db[collection]
        data = [patient.to_dict() for patient in patients]
        self.collection_object.insert_many(data)
        
    def insert_microorganisms_to_mongodb(self, microorganisms: List[Microorganism]):
...
def main():
    ...
    exporter.insert_patients_to_mongodb(patients)
