...
def measure_query_time_avg(mongo_aggregations, collection_patients, collection_microorganism, func, *args, repetitions=30):
    times = []
...
def measure_query_times(mongo_aggregations, collection_patients, collection_microorganism):
    ...
    for description, func, *args in queries:
        avg_time = measure_query_time_avg(mongo_aggregations, collection_patients, collection_microorganism, func, *args)
        times[description] = avg_time
