...
class PerformanceMongoDB:
    ...
    def plot_clustered_heatmap(self) -> None:
        ...
        try:
            ...
            # Ensure there are no NaN values before normalization
            ...
            print(f"Data dimensions after pivoting and normalizing: {data_normalized.shape}")
            ...
            sns.clustermap(data_normalized.T, row_cluster=False, col_cluster=True, col_linkage=linkage_matrix, cmap='viridis')
