...
# Load the CSV file
df = pd.read_csv('../query_optimization/query_performance.csv')
...
import ace_tools as tools; tools.display_dataframe_to_user(name="Codified Query Performance Data", dataframe=df)
