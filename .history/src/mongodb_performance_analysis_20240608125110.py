...
class MongoDBVisualizer:
    ...
    def plot_optimal_indices_heatmap(self, n: int = 1) -> None:
        ...
        for query in optimal_indices.keys():
            ...
            for idx_combination in top_n_rows.columns[1:]:
                optimal_indices[query].extend([idx_combination] * top_n_rows[idx_combination].count())
        ...
        plt.savefig(f"{self.figure_path}optimal_indices_heatmap.png")
        plt.close()
