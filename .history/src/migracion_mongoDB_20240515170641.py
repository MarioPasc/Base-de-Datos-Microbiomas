...
class Sample:
    def __init__(self, sample_id: str, date: str, body_part: str, sample_type: str, patient_id:str):
...
def main():
    ...
    # Creating a dictionary to quickly access samples and microorganisms by Sample_ID
    samples_dict = {sample.sample_id: sample for sample in samples}
    microorganisms_dict = {}
    for microorganism in microorganisms:
        if microorganism.microorganism_id not in microorganisms_dict:
            microorganisms_dict[microorganism.microorganism_id] = []
        microorganisms_dict[microorganism.microorganism_id].append(microorganism)
